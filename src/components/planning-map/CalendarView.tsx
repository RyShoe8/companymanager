...
import { canUserContributeToProject, getTaskAssigneeEmployeeIds } from '@/lib/utils/projectTeam';
import {
  contentPassesAssignmentFilter,
  formatTaskAssigneeLabel as formatTaskAssigneeLabelShared,
...
import { useCalendarActivityTracking } from '@/hooks/calendar/useCalendarActivityTracking';
...
export default function CalendarView({
  ...
  function formatTaskAssigneeLabel(task: IProjectTask): string | undefined {
    return formatTaskAssigneeLabelShared(task, employees);
  }
  ...
  function localContentPassesAssignmentFilter(
            ...
            <div className="relative w-full h-full pointer-events-auto">
              {(() => {
                ...
                return itemPositions.map((pos, idx) => {
                  ...
                  const assignedToId = pos.project!.assignedToEmployeeId?.toString();
                  ...
                  return (
                    ...
                    >
                      {(() => {
                        ...
                        return (
                          <>
                            <div className="px-1.5 py-2.5 md:px-6 md:py-4 shrink-0">
                              <CalendarCardHeader
                                name={name}
                                logo={project.logo}
                                color={displayColor}
