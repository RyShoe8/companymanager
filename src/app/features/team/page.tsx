...
import TeamScreenshot from '@/components/marketing/screenshots/TeamScreenshot';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-16"><AnimateIn><MarketingScreenshotFrame alt="Nucleas team management with capacity bars, workload distribution, and role badges"><TeamScreenshot /></MarketingScreenshotFrame></AnimateIn></section>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16"><div className="max-w-3xl mx-auto flex flex-wrap justify-center gap-4"><Link href="/features/projects" className="px-6 py-3 rounded-xl border border-border text-text-secondary hover:text-primary hover:border-primary/30 transition-all text-sm font-medium">Explore Projects →</Link><Link href="/features/clients" className="px-6 py-3 rounded-xl border border-border text-text-secondary hover:text-primary hover:border-primary/30 transition-all text-sm font-medium">Explore Clients →</Link><Link href="/features/tasks" className="px-6 py-3 rounded-xl border border-border text-text-secondary hover:text-primary hover:border-primary/30 transition-all text-sm font-medium">Explore Tasks →</Link></div></section>
        <MarketingTrialCta title="Start managing your team better" />
      </div>
    </>
  );
}
