...
export const metadata = {
  ...
  description: 'Built-in screenshot capture, screen recording, smart buttons, and assets linked to your projects and tasks. Nucleas OS tools eliminate context switching and keep everything connected to your work.',
  ...
  openGraph: { title: 'Tools — Your Built-In Operating System | Nucleas', description: 'Screenshot capture, recordings, smart buttons, and task-linked assets.', url: `${baseUrl}/features/tools`, type: 'website' as const },
