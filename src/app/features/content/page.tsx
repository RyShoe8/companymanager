  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-16"><AnimateIn><div className="max-w-4xl mx-auto relative"><div className="absolute -inset-4 bg-gradient-to-r from-accent/20 via-primary/10 to-accent/20 rounded-2xl blur-xl opacity-40" /><div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl"><img src="/images/marketing/features-content.png" alt="Nucleas content planning interface with channels and scheduling" className="w-full h-auto" loading="eager" /></div></div></AnimateIn></section>
