...
import ContentScreenshot from '@/components/marketing/screenshots/ContentScreenshot';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-16"><AnimateIn><MarketingScreenshotFrame glow="accent" alt="Nucleas content planning interface with channels and scheduling"><ContentScreenshot /></MarketingScreenshotFrame></AnimateIn></section>
