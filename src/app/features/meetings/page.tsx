...
import MeetingsScreenshot from '@/components/marketing/screenshots/MeetingsScreenshot';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-16"><AnimateIn><MarketingScreenshotFrame alt="Nucleas meeting scheduling with calendar, project insights, and agenda"><MeetingsScreenshot /></MarketingScreenshotFrame></AnimateIn></section>
