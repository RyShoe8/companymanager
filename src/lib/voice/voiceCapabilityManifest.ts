...
export const VOICE_CAPABILITY_MANIFEST: VoiceCapabilityItem[] = [
  ...
  {
    capability: 'Create multiple tasks (voice batch)',
    intentType: 'BATCH_ADD_TASKS',
    supportedByRules: false,
    supportedByLlm: true,
    executorExists: true,
    notes: 'LLM create_task with titles[] (+ optional employee_name); rules fallback does not parse batches.',
  },
