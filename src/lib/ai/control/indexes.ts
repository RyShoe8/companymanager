...
export function ensureAiIndexes() {
  readiness ??= Promise.all([AiObjective, AiPlan, AiRun, AiRunEvent, AiBudget, AiBudgetReservation, AiPlanningJob, AiDispatchLock, AiDispatchUsage, AiRunAcknowledgement, AiSettings, AiSettingsAudit, WorkspaceNotificationEvent]
